...
{{--                 This variable provides access to some useful bits of--}}
{{--                 information such as the current loop index and whether this is the first or last iteration through the loop:--}}
{{--                 example===> is given below from laravel documentaion--}}
...
{{--                @endforeach--}}
                ...
                <div class="carousel-item @if($loop->first) active @endif">
                    <img src="{{ asset($slider->slider_image) }}" width="1300" height="450">
